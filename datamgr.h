...
public:
	...
	//rao
	void walletScanAfterScanningTrue();
...
public:
	...
	//add zxj
	QMap<QString, QMap<int, __int64>>* getAccountBalanceInfo() { return &_account_balance_map; };
...
signals:
	...
	void onWalletScanAfterSettingTransactionTrue(QString);
...
private:
	...
	//add zxj
	QMap<QString, QMap<int, __int64>>  _account_balance_map;
