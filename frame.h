...
public slots:
	...
	void walletSetTransactionScanning(QString result);
	void walletScanAfterScanningTrue(QString result);
...
private slots:
	...
	void frame_showBackUpPage();
	void frame_showBulkSendingPage();
