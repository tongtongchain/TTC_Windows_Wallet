...
//    ui->transferBtn->setStyleSheet("QToolButton{background-image:url(pic2/transfer.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}");
    ui->newsBtn2->setStyleSheet(QString("QToolButton{background-image:url(%1pic2/newsNum.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;color:white;}").arg(QCoreApplication::applicationDirPath() +"/"));
    ui->newsBtn->setStyleSheet(QString("QToolButton{background-image:url(%1pic2/news.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}").arg(QCoreApplication::applicationDirPath() +"/"));
    ui->newsBtn->hide();
    ui->newsBtn2->hide();
	...
	ui->menuBtn->setStyleSheet(QString("QToolButton{background-image:url(%1pic2/setBtn.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
		"QToolButton:hover{background-image:url(%2pic2/set.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}").arg(QCoreApplication::applicationDirPath() +"/").arg(QCoreApplication::applicationDirPath() +"/"));

    ui->divLineLabel->setPixmap(QPixmap(QCoreApplication::applicationDirPath() + "/pic2/divLine.png"));
...
void TitleBar::on_closeBtn_clicked()
{
    ...
    else
    {
		...
		if (DataMgr::getInstance()->showPrivateTips) {
			...
			commonDialog.setText(tr("Keep your private key properly before closing TongTongCoin Wallet"));
