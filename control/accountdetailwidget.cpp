...
AccountDetailWidget::AccountDetailWidget( QWidget *parent) :
    ...
    ui->closeBtn->setStyleSheet(QString("QToolButton{background-image:url(%1pic2/close4.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}").arg(QCoreApplication::applicationDirPath() +"/"));
    QLabel* exportBtnLabel = new QLabel(ui->exportBtn);
    exportBtnLabel->setGeometry(55, 5, 13, 13);
    exportBtnLabel->setPixmap(QPixmap(QCoreApplication::applicationDirPath() + "/pic2/export_icon.png"));
    exportBtnLabel->show();
    ...
    ui->withdrawBtn->setStyleSheet("QToolButton{background-color:#ffffff;color:rgb(123,123,123);border:1px solid rgb(221,221,221);border-radius:3px;}"
                                   "QToolButton:hover{color:rgb(150,150,150);}");
    ui->switchBtn->setStyleSheet(QString("QToolButton{background-image:url(%1pic2/switch_off.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}").arg(QCoreApplication::applicationDirPath() +"/"));
    ...
    //transferBtnLabel->setPixmap(QPixmap(QCoreApplication::applicationDirPath() + "/pic2/transfer3_icon.png"));
...
void AccountDetailWidget::setAccount(QString name) {
    ...
    /*if (DataMgr::getInstance()->getCurrentAssetType() == "TTCOIN") {
	...
	QString display_amount = addingCommasToAmount_Main(checkZero(balance.toDouble()));
    ui->balanceLabel->setText(QString("<font style=\"font-size:12px\" color=#000000>" + display_amount +
...
QString AccountDetailWidget::addingCommasToAmount_Main(QString amount)
{
