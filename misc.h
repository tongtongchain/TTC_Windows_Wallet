...
#define IDE_PATH "TTchainDevelopmentTool"
#define ACHAIN "TTCHAIN"

#define MODULE_ACHAIN "TTCHAINDEVELOPMENTTOOL"
#define TTCOIN_WALLET_VERSION "2.2.0"
#define AUTO_REFRESH_TIME 10000
//#define AUTO_REFRESH_TIME 1000000
#define PWD_LOCK_TIME  7200
#ifdef WIN32
#define CHAIN_RPC_PORT 60010
#else
#define CHAIN_RPC_PORT 8299
#endif
...
#else
    #define TOKEN_DOMAIN "https://api.tongtongchain.com/"
#endif


#define TOKEN_REQ  TOKEN_DOMAIN "wallets/api/browser/ttcoin/contractTransactionAll?"
#define OTHER_TOKEN_REQ TOKEN_DOMAIN "wallets/api/browser/ttcoin/contractTransactions?"
#define CON_CONFOG_URL TOKEN_DOMAIN "wallets/api/browser/ttcoin/getAllContracts?status=2"
