    ...
    ui(new Ui::MainPage)
{
    ...
    //addAccountBtnLabel->setPixmap(QPixmap(QCoreApplication::applicationDirPath() + "/pic2/addAccount_icon.png"));
...
void MainPage::updateAccountList()
{
	...
	for( int i = 0; i < size; i++) {
		...
		//if (DataMgr::getInstance()->getCurrentAssetType() == COMMONASSET) {
			...
			//test log
			//{
			//	QString log("Get accountName balance:");
			//	log += accountName;
			//	log += "| ";
			//	log += balance;
        ...
        QString balanceNew = MainPage::addingCommasToAmount_Main(checkZero(balanceValue));
        if (item2 == NULL)
        {
...
void MainPage::refresh()
{
	...
	qDebug() << "mainpage refreshing really ----------------------";
    updateAccountList();
    updateTotalBalance();
...
void MainPage::retranslator(QString language)
{
    ...
    if( language == "Simplified Chinese") {
		ui->addAccountBtn->setStyleSheet(QString("QToolButton{background-image:url(%1pic2/addAccount.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;background-color:rgb(229,229,229);}"
			"QToolButton:hover{background-image:url(%2pic2/addAccount_hover.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;background-color:rgb(229,229,229);}").arg(QCoreApplication::applicationDirPath() +"/").arg(QCoreApplication::applicationDirPath() +"/"));

    }
	else if (language == "Korean") {
		ui->addAccountBtn->setStyleSheet(QString("QToolButton{background-image:url(%1pic2/addAccount_Ko.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;background-color:rgb(229,229,229);}"
			"QToolButton:hover{background-image:url(%2pic2/addAccount_hover_Ko.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;background-color:rgb(229,229,229);}").arg(QCoreApplication::applicationDirPath() +"/").arg(QCoreApplication::applicationDirPath() +"/"));
        ...
        ui->addAccountBtn->setStyleSheet(QString("QToolButton{background-image:url(%1pic2/addAccount_En.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;background-color:rgb(229,229,229);}"
                                         "QToolButton:hover{background-image:url(%2pic2/addAccount_hover_En.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;background-color:rgb(229,229,229);}").arg(QCoreApplication::applicationDirPath() +"/").arg(QCoreApplication::applicationDirPath() +"/"));
...
void MainPage::totalBalance(QString result)
{
	...
	QString display_amount = addingCommasToAmount_Main(checkZero(totalBalance));
	//QString display_amount = addingCommasToAmount_Main("9896802769.30806");

    ui->totalBalanceLabel->setText( "<body><font style=\"font-size:26px\" color=#000000>" + display_amount
...
QString MainPage::addingCommasToAmount_Main(QString amount)
{
...
{
    RenameDialog renameDialog(name);
