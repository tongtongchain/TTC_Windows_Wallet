...
//  ui->enterBtn->setIcon(QPixmap(QCoreApplication::applicationDirPath() + "/pic2/arrow.png"));
...
//  ui->minBtn->setIcon(QPixmap(QCoreApplication::applicationDirPath() + "/pic2/minimize.png"));
...
//    ui->closeBtn->setIcon(QPixmap(QCoreApplication::applicationDirPath() + "/pic2/close.png"));
//    ui->closeBtn->setIconSize(QSize(14,14));
   ...
   // ui->textLabel->setPixmap(QPixmap(QCoreApplication::applicationDirPath() + "/pic2/Achain-Wallet.png"));
	...
	if (language.isEmpty() || language == "Korean"){
