...
public:
    ...
    void setupUi(QDialog *RenameDialog)
    {
        ...
        checkBtn->setGeometry(QRect(440, 100, 50, 30));
    ...
    void retranslateUi(QDialog *RenameDialog)
    {
        ...
        label_2->setText(QApplication::translate("RenameDialog", "<html><head/><body><p><span style=\" color:#282828;\">* This account name is only used as the identity of the local account.</span></p></body></html>", Q_NULLPTR));
        ...
        checkBtn->setText(QApplication::translate("RenameDialog", "Check", Q_NULLPTR));
    } // retranslateUi
