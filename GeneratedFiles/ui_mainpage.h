...
"color: rgb(40, 40, 40);"));
        ...
        totalBalanceLabel->setGeometry(QRect(580, 42, 400, 30));
        QFont font2;
        ...
        label->setGeometry(QRect(490, 42, 80, 30));
        QFont font3;
...
"background-color: rgb(255, 255, 255);"));
    ...
    void retranslateUi(QWidget *MainPage)
    {
        ...
        ___qtablewidgetitem2->setText(QApplication::translate("MainPage", "Balance/TTCOIN", Q_NULLPTR));
        loadingLabel->setText(QApplication::translate("MainPage", "Loading data, please wait...", Q_NULLPTR));
        initLabel->setText(QApplication::translate("MainPage", "Please add your first TongTongCoin account.", Q_NULLPTR));
    } // retranslateUi
