...
public:
    ...
    void setupUi(QWidget *TransferPage)
    {
        ...
        addressLabel2->setGeometry(QRect(50, 110, 101, 31));
        QFont font2;
        ...
        changeAccountLabel->setGeometry(QRect(130, 40, 61, 24));
        changeAccountLabel->setFont(font3);
        messageLabel = new QLabel(TransferPage);
        messageLabel->setObjectName(QStringLiteral("messageLabel"));
        messageLabel->setGeometry(QRect(50, 323, 81, 30));
        ...
        sendtoLabel->setGeometry(QRect(50, 158, 81, 30));
        ...
        amountLabel->setGeometry(QRect(50, 213, 61, 30));
        ...
        feeLabel->setGeometry(QRect(50, 268, 51, 30));
        ...
        accountComboBox->setGeometry(QRect(200, 40, 120, 24));
        QFont font7;
    ...
    void retranslateUi(QWidget *TransferPage)
    {
        ...
        balanceLabel->setText(QApplication::translate("TransferPage", "<html><head/><body><p><span style=\" font-size:26px;\">0.00</span><span style=\" font-size:12px;\"> TTCOIN</span></p></body></html>", Q_NULLPTR));
        ...
        changeAccountLabel->setText(QApplication::translate("TransferPage", "Account", Q_NULLPTR));
        ...
        unitLabel->setText(QApplication::translate("TransferPage", "TTCOIN", Q_NULLPTR));
        feeLabel->setText(QApplication::translate("TransferPage", "Fee", Q_NULLPTR));
        feeLineEdit->setText(QString());
        unitLabel2->setText(QApplication::translate("TransferPage", "TTCOIN", Q_NULLPTR));
