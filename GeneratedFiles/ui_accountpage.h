...
public:
    ...
    void setupUi(QWidget *AccountPage)
    {
        ...
        addressLabel2->setGeometry(QRect(260, 44, 51, 20));
        QFont font1;
...
"background:transparent;"));
        ...
        addressLabel->setGeometry(QRect(319, 46, 111, 16));
        QFont font2;
        ...
        copyBtn->setGeometry(QRect(430, 50, 11, 13));
        ...
        accountComboBox->setGeometry(QRect(130, 42, 120, 24));
        QFont font3;
        ...
        label->setGeometry(QRect(23, 42, 101, 24));
        label->setFont(font1);
...
"background:transparent;"));
        ...
        label_2->setGeometry(QRect(40, 115, 51, 24));
        ...
        transactionTypeComboBox->setGeometry(QRect(80, 115, 64, 24));
        ...
        downloadCSVBtn = new QToolButton(AccountPage);
        downloadCSVBtn->setObjectName(QStringLiteral("downloadCSVBtn"));
        downloadCSVBtn->setGeometry(QRect(160, 115, 131, 24));
        QFont font7;
        font7.setFamily(QString::fromUtf8("\345\276\256\350\275\257\351\233\205\351\273\221"));
        font7.setPointSize(9);
        downloadCSVBtn->setFont(font7);
        downloadCSVBtn->setCursor(QCursor(Qt::PointingHandCursor));
        downloadCSVBtn->setFocusPolicy(Qt::NoFocus);
        downloadCSVBtn->setStyleSheet(QStringLiteral(""));
    ...
    void retranslateUi(QWidget *AccountPage)
    {
        ...
        label_13->setText(QApplication::translate("AccountPage", "Fee/TTCOIN", Q_NULLPTR));
        ...
        downloadCSVBtn->setText(QApplication::translate("AccountPage", "Export Trans. History", Q_NULLPTR));
    } // retranslateUi
