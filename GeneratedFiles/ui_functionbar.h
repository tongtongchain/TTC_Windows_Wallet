...
public:
    ...
    QToolButton *button_backup;
    QToolButton *button_bulk_sending;
    ...
    void setupUi(QWidget *FunctionBar)
    {
        ...
        assertComboBox->setGeometry(QRect(40, 20, 77, 26));
        QFont font3;
        ...
        assertComboBox->setLayoutDirection(Qt::LeftToRight);
        ...
        button_backup = new QToolButton(FunctionBar);
        button_backup->setObjectName(QStringLiteral("button_backup"));
        button_backup->setGeometry(QRect(20, 340, 92, 63));
        button_backup->setFont(font1);
        button_backup->setCursor(QCursor(Qt::PointingHandCursor));
        button_backup->setFocusPolicy(Qt::NoFocus);
        button_bulk_sending = new QToolButton(FunctionBar);
        button_bulk_sending->setObjectName(QStringLiteral("button_bulk_sending"));
        button_bulk_sending->setGeometry(QRect(20, 340, 92, 63));
        button_bulk_sending->setFont(font1);
        button_bulk_sending->setCursor(QCursor(Qt::PointingHandCursor));
        button_bulk_sending->setFocusPolicy(Qt::NoFocus);
    ...
    void retranslateUi(QWidget *FunctionBar)
    {
        ...
        versionLabel_2->setText(QApplication::translate("FunctionBar", "TTCOIN Wallet\n"
"Ver.1.0.0", Q_NULLPTR));
        logoLabel->setText(QString());
        assertComboBox->clear();
        assertComboBox->insertItems(0, QStringList()
         << QApplication::translate("FunctionBar", "TTCOIN", Q_NULLPTR)
        );
        assertComboBox->setCurrentText(QApplication::translate("FunctionBar", "TTCOIN", Q_NULLPTR));
        button_backup->setText(QApplication::translate("FunctionBar", "Backup", Q_NULLPTR));
        button_bulk_sending->setText(QApplication::translate("FunctionBar", "Bulk Sending", Q_NULLPTR));
    } // retranslateUi
