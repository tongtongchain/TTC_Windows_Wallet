    ...
    ui(new Ui::SingleContactWidget)
{
    ...
    ui->deleteBtn->setStyleSheet(QString("QToolButton{background-image:url(%1pic2/deleteContact.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
                                 "QToolButton:hover{background-image:url(%2pic2/deleteContact_hover.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}").arg(QCoreApplication::applicationDirPath() +"/").arg(QCoreApplication::applicationDirPath() +"/"));
//    ui->deleteBtn->setToolTip(QString::fromLocal8Bit("删除联系人"));
    ...
    ui->transferBtn->setStyleSheet(QString("QToolButton{background-image:url(%1pic2/transfer2.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
                                   "QToolButton:hover{background-image:url(%2pic2/transfer2_hover.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}").arg(QCoreApplication::applicationDirPath() +"/").arg(QCoreApplication::applicationDirPath() +"/"));
    ui->editBtn->setStyleSheet(QString("QToolButton{background-image:url(%1pic2/contactEdit.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
                               "QToolButton:hover{background-image:url(%2pic2/contactEdit_hover.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}").arg(QCoreApplication::applicationDirPath() +"/").arg(QCoreApplication::applicationDirPath() +"/"));
    ui->deleteBtn->hide();
    ui->transferBtn->hide();
    ui->editBtn->hide();
...
void SingleContactWidget::enterEvent(QEvent *)
{
    ...
    if( language.isEmpty() || language == "English")
    {
        ...
        ui->transferBtn->setStyleSheet(QString("QToolButton{background-image:url(%1pic2/transfer2_En.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
                                       "QToolButton:hover{background-image:url(%2pic2/transfer2_hover_En.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}").arg(QCoreApplication::applicationDirPath() +"/").arg(QCoreApplication::applicationDirPath() +"/"));
    }
	else if (language.isEmpty() || language == "Korean")
	{
		ui->transferBtn->setGeometry(603, 28, 41, 13);
		ui->transferBtn->setStyleSheet(QString("QToolButton{background-image:url(%1pic2/transfer2_Ko.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
			"QToolButton:hover{background-image:url(%2pic2/transfer2_hover_Ko.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}").arg(QCoreApplication::applicationDirPath() +"/").arg(QCoreApplication::applicationDirPath() +"/"));
	}
    else
    {
        ui->transferBtn->setGeometry(603,28,41,13);
