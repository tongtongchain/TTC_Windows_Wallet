...
FirstLogin::FirstLogin(QWidget *parent) :
    ...
    QPalette palette;
    palette.setBrush(QPalette::Background, QBrush(QPixmap(QCoreApplication::applicationDirPath() + "/pic2/bg.png")));
    setPalette(palette);
    ...
    ui->minBtn->setStyleSheet(QString("QToolButton{background-image:url(%1/pic2/minimize2.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
                              "QToolButton:hover{background-image:url(%2/pic2/minimize_hover.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}").arg(QCoreApplication::applicationDirPath() +"/").arg(QCoreApplication::applicationDirPath() +"/"));
    ui->closeBtn->setStyleSheet(QString("QToolButton{background-image:url(%1/pic2/close2.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
                                "QToolButton:hover{background-image:url(%2/pic2/close_hover.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}").arg(QCoreApplication::applicationDirPath() +"/").arg(QCoreApplication::applicationDirPath() +"/"));
    ui->correctLabel->setPixmap(QPixmap(QCoreApplication::applicationDirPath() + "/pic2/correct2.png"));
    ui->correctLabel2->setPixmap(QPixmap(QCoreApplication::applicationDirPath() + "/pic2/correct2.png"));
    ...
    if (language.isEmpty() || language == "English") {
        ui->tipLabel2->setPixmap(QPixmap(QCoreApplication::applicationDirPath() + "/pic2/pwdTip_En.png"));
        ui->tipLabel2->setGeometry(602, 148, 316, 124);
        
    } 
	else if (language.isEmpty() || language == "Korean"){
		ui->tipLabel2->setPixmap(QPixmap(QCoreApplication::applicationDirPath() + "/pic2/pwdTip_Ko.png"));
		ui->tipLabel2->setGeometry(602, 148, 319, 124);
		ui->versionLabel->setGeometry(100, 12, 81, 14);
	}
	else {
        ui->tipLabel2->setPixmap(QPixmap(QCoreApplication::applicationDirPath() + "/pic2/pwdTip.png"));
        ui->tipLabel2->setGeometry(602, 148, 319, 124);
    }
...
void FirstLogin::on_closeBtn_clicked() {
    ...
    commonDialog.setText(tr("Close TongTongCoin Wallet?"));
