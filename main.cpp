...
#define UPDATE_INSTALL_TOOL "TTCUpTool.exe"
#define UPDATE_TOOL_NAME "TTCUpdate.exe"
...
bool checkOnly()
{
	const char filename[] = "/tmp/TTCWallet";
...
bool checkOnly()  //zxlwin
{
    ...
    //  创建互斥量  
    HANDLE m_hMutex  =  CreateMutex(NULL, FALSE,  L"TTCWallet 3.0.4" );
    //  检查错误代码 
...
{
	QString allData = "mac=" + getMAC() + "&version=" + TTCOIN_WALLET_VERSION;
#ifdef _DEBUG
...
inline QByteArray getPostData()
{
	...
	jsonObj.insert("version", TTCOIN_WALLET_VERSION);
...
int main(int argc, char *argv[])
{
	...
	a.setWindowIcon(QIcon("pic2/TTCOIN.ico"));
#ifdef WIN32
	refreshIcon();  //zxlwin
