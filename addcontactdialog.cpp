...
void AddContactDialog::jsonDataUpdated(QString id)
{
    ...
    if( result == "\"result\":null")
    {
        ...
        ui->tipLabel2->setPixmap(QPixmap(QCoreApplication::applicationDirPath() + "/pic2/wrong.png"));
        ui->okBtn->setEnabled(false);
    }
    else
    {
        ui->tipLabel->setText(tr("<body><font color=green>Valid address</font></body>"));
        ui->tipLabel2->setPixmap(QPixmap(QCoreApplication::applicationDirPath() + "/pic2/correct.png"));
        ui->okBtn->setEnabled(true);
    }
