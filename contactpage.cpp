...
//    connect( Goopal::getInstance(), &Goopal::jsonDataUpdated, this, &ContactPage::jsonDataUpdated);
    ...
    if( language.isEmpty() || language == "English")
    {
        ui->addContactBtn->setStyleSheet(QString("QToolButton{background-image:url(%1pic2/addContactBtn_En.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
                                         "QToolButton:hover{background-image:url(%2pic2/addContactBtn_hover_En.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}").arg(QCoreApplication::applicationDirPath() +"/").arg(QCoreApplication::applicationDirPath() +"/"));

    }
	else if (language.isEmpty() || language == "Korean")
	{
		ui->addContactBtn->setStyleSheet(QString("QToolButton{background-image:url(%1pic2/addContactBtn_Ko.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
			"QToolButton:hover{background-image:url(%2pic2/addContactBtn_hover_Ko.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}").arg(QCoreApplication::applicationDirPath() +"/").arg(QCoreApplication::applicationDirPath() +"/"));
    ...
    else
    {
        ui->addContactBtn->setStyleSheet(QString("QToolButton{background-image:url(%1pic2/addContactBtn.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}"
                                         "QToolButton:hover{background-image:url(%2pic2/addContactBtn_hover.png);background-repeat: repeat-xy;background-position: center;background-attachment: fixed;background-clip: padding;border-style: flat;}").arg(QCoreApplication::applicationDirPath() +"/").arg(QCoreApplication::applicationDirPath() +"/"));
